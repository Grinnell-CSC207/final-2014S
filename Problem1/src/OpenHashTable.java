    ...
    implements Dictionary<K,V>, Iterable<V>
{
  ...
  /*
      Code copied from Problem 4 of the Spring 2014 section of CSC 207.

      That code, in turn, is based closely on the file HashTable.java
      from the Tao of Java's laboratory on hash tables by Samuel
      A. Rebelsky, available at
	 <https://github.com/Grinnell-CSC207/hashtables>
      Changes include: renaming the class, squashing some bugs,
      implementing some unimplemented or partially implemented
      methods (such as find and expand), removing the reporting
      code, adding a constructor that takes an initial capacity,
      and more.
